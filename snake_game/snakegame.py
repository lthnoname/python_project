...
def draw():
    ...
    for tile in snake_body:
        canvas.create_rectangle(tile.x, tile.y, tile.x + TITLE_SIZE, snake.y + TITLE_SIZE, fill = "lime green")
    ...
    window.after(90, draw) #100ms = 1/10 sec, 10frames/second
